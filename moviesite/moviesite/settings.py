...
DATABASES = {
    'default': {
        ...
        'NAME': 'movie_new',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'root',
        'PASSWORD': 'zeus#1982',
        'HOST': '127.0.0.1',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
        'PORT': '7799',                      # Set to empty string for default.
    }
}
...
SECRET_KEY = '6n(9n9&1o(tu&lf_a6bipwgfy=84(@h_dkqf+9(q1)@z&#6gwc'
...
TEMPLATE_DIRS = (
    ...
    "/home/wangwei/moviesite/moviesite/templates/",
)
